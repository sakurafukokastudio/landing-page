    ...
    <v-container class="pa-0">
        <v-layout wrap align-center justify-center row fill-height >
           <v-flex xs12 md3 lg3 class="pa-2">
               ...
               <p class="google-font" style="font-size:110%">We learn, share and spread knowledge about Information Technology for Creative People.</p>
               ...
               <!-- <p class="google-font" style="font-size:110%">About different Google technologies</p>
                ...
                <v-btn :href="chapterDetails.journalWeb" outline rel="noreferer" target="_blank" round color="cyan" style="text-transform: capitalize;border-radius:5px;text-transform: capitalize;" flat  class="ml-0 google-font hidden-md-and-down" dark>Learn more</v-btn>
            ...
            <v-flex xs12 md9 lg9 class="">
                <v-layout row wrap>
                    ...
                    <v-flex xs6 sm6 md3 lg3 class="text-xs-center pa-2">
                        ...
                        <p class="google-font" style="font-size:110%">Get updated with the latest technology information</p>
                    </v-flex>
                    ...
                    <v-flex xs6 sm6 md3 lg3 class="text-xs-center pa-2">
                        ...
                        <p class="google-font" style="font-size:110%">Share knowledge in different places, school and communities</p>
                    </v-flex>

                    <v-flex xs6 sm6 md3 lg3 class="text-xs-center pa-2">
                        <v-icon large style="font-size:300%">airplay</v-icon>
                        <p class="google-font" style="font-size:130%">Live Viewing Parties</p>
                        <p class="google-font" style="font-size:110%">Hackathon! Ideathon! Share your ideas to the worldwide</p>
                    </v-flex>
